...
extern uint   TickIgnoreMethod = 0; // Tick ignore method (0-5, 0 - off)
...
extern ENUM_MA_METHOD Alligator_MA_Method = 1; // MA Method
...
extern ENUM_TRAIL_TYPE Alligator_TrailingStopMethod = -6; // Trail stop method
extern ENUM_TRAIL_TYPE Alligator_TrailingProfitMethod = 12; // Trail profit method
extern double Alligator_SignalLevel = 0.10000000; // Signal level
extern int Alligator1_SignalMethod = 16; // Signal method for M1 (-63-63)
extern int Alligator5_SignalMethod = 16; // Signal method for M5 (-63-63)
extern int Alligator15_SignalMethod = 8; // Signal method for M15 (-63-63)
extern int Alligator30_SignalMethod = 2; // Signal method for M30 (-63-63)
...
extern int Bands15_SignalMethod = 96; // Signal method for M15 (-127-127)
extern int Bands30_SignalMethod = -104; // Signal method for M30 (-127-127)
...
extern ENUM_TRAIL_TYPE DeMarker_TrailingProfitMethod = 23; // Trail profit method
extern int DeMarker1_SignalMethod = 4; // Signal method for M1 (-31-31)
extern int DeMarker5_SignalMethod = -16; // Signal method for M5 (-31-31)
extern int DeMarker15_SignalMethod = 2; // Signal method for M15 (-31-31)
extern int DeMarker30_SignalMethod = 1; // Signal method for M30 (-31-31)
...
extern ENUM_TRAIL_TYPE Envelopes_TrailingStopMethod = 10; // Trail stop method
extern ENUM_TRAIL_TYPE Envelopes_TrailingProfitMethod = -6; // Trail profit method
extern int Envelopes_SignalLevel = 0; // Signal level
extern int Envelopes1_SignalMethod = 113; // Signal method for M1 (-127-127)
extern int Envelopes5_SignalMethod = -95; // Signal method for M5 (-127-127)
extern int Envelopes15_SignalMethod = 81; // Signal method for M15 (-127-127)
extern int Envelopes30_SignalMethod = -120; // Signal method for M30 (-127-127)
...
extern ENUM_TRAIL_TYPE Fractals_TrailingStopMethod = -6; // Trail stop method
extern ENUM_TRAIL_TYPE Fractals_TrailingProfitMethod = 0; // Trail profit method
...
extern int MA_Period_Medium = 27; // Period Medium
extern int MA_Period_Slow = 56; // Period Slow
extern double MA_Period_Ratio = 1.0; // Period ratio between timeframes (0.5-1.5)
extern int MA_Shift = 4; // Shift
extern int MA_Shift_Fast = 0; // Shift Fast (+1)
extern int MA_Shift_Medium = 3; // Shift Medium (+1)
extern int MA_Shift_Slow = 0; // Shift Slow (+1)
extern int MA_Shift_Far = 6; // Shift Far (+2)
extern ENUM_MA_METHOD MA_Method = 0; // MA Method
extern ENUM_APPLIED_PRICE MA_Applied_Price = 6; // Applied Price
extern ENUM_TRAIL_TYPE MA_TrailingStopMethod = 8; // Trail stop method
extern ENUM_TRAIL_TYPE MA_TrailingProfitMethod = 0; // Trail profit method
extern double MA_SignalLevel = 2.2; // Signal level
extern int MA1_SignalMethod = 56; // Signal method for M1 (-127-127)
extern int MA5_SignalMethod = -96; // Signal method for M5 (-127-127)
extern int MA15_SignalMethod = 32; // Signal method for M15 (-127-127)
extern int MA30_SignalMethod = -64; // Signal method for M30 (-127-127)
...
extern int MACD_Period_Fast = 13; // Period Fast
extern int MACD_Period_Slow = 29; // Period Slow
extern int MACD_Period_Signal = 16; // Period for signal
extern double MACD_Period_Ratio = 0.4; // Period ratio between timeframes (0.5-1.5)
extern ENUM_APPLIED_PRICE MACD_Applied_Price = 3; // Applied Price
extern int MACD_Shift = 6; // Shift
extern int MACD_Shift_Far = 0; // Shift Far
extern ENUM_TRAIL_TYPE MACD_TrailingStopMethod = 13; // Trail stop method
extern ENUM_TRAIL_TYPE MACD_TrailingProfitMethod = 0; // Trail profit method
extern double MACD_SignalLevel = 0.2; // Signal level
extern int MACD1_SignalMethod = 1; // Signal method for M1 (-31-31)
extern int MACD5_SignalMethod = 1; // Signal method for M5 (-31-31)
extern int MACD15_SignalMethod = 1; // Signal method for M15 (-31-31)
extern int MACD30_SignalMethod = 1; // Signal method for M30 (-31-31)
...
extern int RSI_Period = 17; // Period
extern double RSI_Period_Ratio = 0.1; // Period ratio between timeframes (0.5-1.5)
extern ENUM_APPLIED_PRICE RSI_Applied_Price = 0; // Applied Price
extern int RSI_Shift = 4; // Shift
extern ENUM_TRAIL_TYPE RSI_TrailingStopMethod = 2; // Trail stop method
extern ENUM_TRAIL_TYPE RSI_TrailingProfitMethod = 0; // Trail profit method
extern int RSI_SignalLevel = 29; // Signal level
...
extern double SAR_Step_Ratio = 0.9; // Step ratio between timeframes (0.5-1.5)
extern double SAR_Maximum_Stop = 0.2; // Maximum stop
extern int SAR_Shift = 1; // Shift
extern ENUM_TRAIL_TYPE SAR_TrailingStopMethod = 19; // Trail stop method
extern ENUM_TRAIL_TYPE SAR_TrailingProfitMethod = 0; // Trail profit method
extern double SAR_SignalLevel = -1; // Signal level
extern int SAR1_SignalMethod = 6; // Signal method for M1 (-127-127)
extern int SAR5_SignalMethod = 1; // Signal method for M5 (-127-127)
extern int SAR15_SignalMethod = 100; // Signal method for M15 (-127-127)
extern int SAR30_SignalMethod = 71; // Signal method for M30 (-127-127)
...
extern int WPR_Period = 13; // Period
extern double WPR_Period_Ratio = 0.9; // Period ratio between timeframes (0.5-1.5)
extern int WPR_Shift = 2; // Shift
extern int WPR_SignalLevel = 15; // Signal level
extern ENUM_TRAIL_TYPE WPR_TrailingStopMethod = 0; // Trail stop method
extern ENUM_TRAIL_TYPE WPR_TrailingProfitMethod = 0; // Trail profit method
extern int WPR1_SignalMethod = 1; // Signal method for M1 (-63-63)
